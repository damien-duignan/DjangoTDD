...
REPO_URL = 'https://github.com/duignand/DjangoTDD.git'
...
def _update_static_files(source_folder):
    run('cd %ssuperlists/ && ../../virtualenv/bin/python3 manage.py collectstatic --noinput' % (source_folder))


def _update_database(source_folder):
    run('cd %ssuperlists/ && ../../virtualenv/bin/python3 manage.py migrate --noinput' % (source_folder,))
